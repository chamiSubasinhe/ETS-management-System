        ...
        <div class="container-fluid">
                <div class="row clearfix js-sweetalert">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class = "body">
                            <form method = "post" action = "includes/updateStaffQuery.php">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9" >
                                <?php  
                                    ...
                                    echo "<img src='includes/uploads/".$emp_id.".jpg' style='max-width:300px;max-height:300px12'>";
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                    <div class="form-group">
                                        <div class="form-line">
                                           <input type="text" class="form-control" id="emp_id" name="emp_id" value="<?php echo $rows['staffID']; ?>" title="This field should contain 12 chracters. eg:SFXXXXXX123456" minlength="12" maxlength="12"pattern="([S][F][A-Z][A-Z][A-Z][A-Z][0-9][0-9][0-9][0-9][0-9][0-9])" placeholder="SFXXXXXX123456" required>
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" id="managed_by" name="managed_by" value="<?php echo $rows['managedBy']; ?>" title="This field should contain 12 chracters. eg:SFXXXXXX123456" minlength="12" maxlength="12" required>
                                            <div>
                                                 <p id="searchList1"></p>
                                            </div>
                                            <div class="help-info">Ex: SFXXXXXX123456</div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class = "col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                <input type = "submit" class="btn bg-blue btn-block waves-effect" name="updatesm" value="UPDATE"/></button>
