        ...
        <div class="container-fluid">
            <div class="row clearfix js-sweetalert">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class = "body">
                        <form method="post" action="payslips.php">
        ...
        <div class="container-fluid">
                <div class="row clearfix js-sweetalert">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2 align="center"><b>Payslip Details</h2></b>
                            <div class = "col-sm-9"></div>
                        </div>
                            
                        <div class = "body">
                            <form action="pdfpayslipnew.php" method="POST">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class = "col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                <input type ="submit" class="btn bg-blue btn-block waves-effect" name="genpayslip" value="GENERATE PAYSLIP"/></button>
                ...
                <div class="row clearfix js-sweetalert">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class = "col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                <input type ="submit" class="btn bg-blue btn-block waves-effect" name="genpayallslips" value="GENERATE PAYSLIP"/></button>
