...
<?php
	...
	if(isset($_POST["ExamID"]) && isset($_POST["courseID"]) && isset($_POST["courseID"]))
	{
		$ExamID=$_POST["ExamID"];
		...
		$query2=mysqli_query($conn,"select * from exam where ExamID='".$ExamID."' " );
		...
		if(isset($_POST["expire"]))
	{
		...
		{
			$message2= '1 record  Successfully expired!';
			$flag=1;
		}
	}
		...
		if(isset($_POST["delete"]))
	{
		...
		{
			$message3= '1 record Successfully Deleted!';
			$flag=1;
		}
	}
	...
	{
		$message3 = "No any Deleted record";
		$flag=0;
	}
	?>
								...
								<div class="col-sm-6">
                                    <div class="form-group">
										...
										<input type="text" name="ExamID" value= "<?php echo $ExamID; ?>" style="visibility:hidden;" class="form-control" placeholder="Exam ID" />
                                           Exam ID: <input type="text" value= "<?php echo $ExamID; ?>" class="form-control" placeholder="Exam ID" disabled/>
                                        </div>
                                    </div>
                                </div>
							    <div class="col-sm-12">
								 ...
								 <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
											...
											Module ID:<input type="text" value= "<?php echo $moduleID; ?>" class="form-control" placeholder="module ID" disabled/>
                                        </div>
                                    </div> 
                                </div>
								<div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                          Duration:  <input type="text"  name="duration" class="form-control"  value="<?php  echo $duration;  ?>" placeholder="Duration" />
                                        </div>
                                    </div>
                                </div>
								<div class="col-sm-12">
