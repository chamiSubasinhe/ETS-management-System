...
<?php
		...
		if(isset($_GET["update"]))
	{
		...
		$updateString="UPDATE exam SET duration='".$duration."' WHERE courseID='".$courseID."' ,moduleID='".$moduleID."'WHERE duration='".$duration."'";
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
						...
						<form method="GET" action="upex.php" >
						<div class="row clearfix">
								...
								<div class="col-sm-6">
                                    <div class="form-group">
										...
										<input type="text" name="ExamID" value= "<?php echo $ExamID; ?>" style="visibility:hidden;" class="form-control" placeholder="Exam ID" />
                                            <input type="text" value= "ExamID:<?php echo $ExamID; ?>" class="form-control" placeholder="Student ID" disabled/>
                                        </div>
                                    </div>
                                </div>
							    <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
											...
											<input type="text" value= "<?php echo $courseID; ?>" class="form-control" placeholder="course ID" disabled/>
                                        </div>
                                    </div> 
                                </div>
								<div class="col-sm-12">
								...
								<div class="form-group">
                                    ...
                                    <button class="btn btn-danger waves-effect" data-type="cancel" name="expireCertificate" id="expireModule" value="expireModule">Expire</button></td>
								</div>
								</div>
