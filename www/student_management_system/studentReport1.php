...
var myChart3 = new Chart(ctx2, {
    ...
    data: {
        ...
        datasets: [{
            label: 'Students',
            data: ["<?php echo $arr[6]; ?>","<?php echo $arr[7]; ?>","<?php echo $arr[8]; ?>","<?php echo $arr[9]; ?>","<?php echo $arr[10]; ?>","<?php echo $arr[11]; ?>","<?php echo $arr[0]; ?>",,"<?php echo $arr[1]; ?>","<?php echo $arr[3]; ?>","<?php echo $arr[4];?>","<?php echo $arr[5];?>","<?php echo $arr[6];?>"],
            backgroundColor: ["#3e95cd", "#3e95cd","#3e95cd","#3e95cd","#3e95cd", "#3e95cd", "#3e95cd","#3e95cd","#3e95cd","#3e95cd", , "#3e95cd","#3e95cd", "#3e95cd", "#3e95cd","#3e95cd","#3e95cd","#c45850", "#3e95cd", "#8e5ea2","#3cba9f","#e8c3b9","#c45850", , "#8e5ea2","#3cba9f"],
            borderWidth: .4
        }]
    },
