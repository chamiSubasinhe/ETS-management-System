...
$s1="INSERT INTO staffattendence(staffID)VALUES('".$staffID."')";


$insert=mysqli_query($conn,$s1);

if(isset($_POST['staffID'] ) == true)
{
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST" >
                                ...
                                <button class="btn btn-primary waves-effect"  type="submit" name="Submit" value="Submit">add</button>
