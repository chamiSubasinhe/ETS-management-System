...
<?php
	...
	{
		$variableSetting = mysql_real_escape_string(str_replace(' ', '_', trim($_POST['variableNew'], " ")));
		$valueSetting = mysql_real_escape_string($_POST['valueNew']);
		$staticSetting = mysql_real_escape_string($_POST['staticNew']);
