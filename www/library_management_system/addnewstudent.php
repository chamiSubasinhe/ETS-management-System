...
<!-- Load system variables ---------------------------------------->
	...
	if(isset($_POST['AddStudent'])){
		...
		if($flag==0){
			$sql1 = "INSERT INTO student (stuID,nameWithInit,nameInFull,dob,nic,gender,address,ol,al) VALUES( '".$stuID."','".$nameWithInit."','".$nameInFull."','".$dob."','".$nic."','".$gender."','".$address."','".$ol."','".$al."')";
		}
...
<html>
	...
	<!-- Main page content  ----------------------------->
		...
		<div class="alert alert-<?php if($flag==0){echo 'danger';}else if($flag==1){ echo 'success';} ?> alert-dismissible" data-auto-dismiss="5000" role="alert">
                        ...
                        <div class="body">
                            <form id="form_validation"  action="addnewstudent.php" method="POST">
